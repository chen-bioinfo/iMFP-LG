...
sys.path.append('../')
from utils.data_helpers import LoadMultiPeptideClassificationDataset, get_json_file
...
class TrainConfig:
    def __init__(self, model_num):
        ...
        self.dataset_dir = os.path.join(self.project_dir, 'data','MFTP')
        ...
        self.data_name = 'Peptide_MFTP'

        # log path
        self.model_save_dir = os.path.join(self.project_dir, 'cache', 'MFTP')  
        self.logs_save_dir = os.path.join(self.project_dir, 'logs', 'MFTP')  
        ...
        self.pooling = 'pooler'    
        self.res_path = os.path.join(self.project_dir, 'res', 'MFTP', 'result') # the save path of predicted results
